...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    public static class TreeNode<T extends Comparable<T>> {
        ...
        public TreeNode(T key, boolean color, TreeNode<T> parent, TreeNode<T> left, TreeNode<T> right) {
            this.key = key;
            this.color = color;
            this.parent = parent;
            this.left = left;
    ...
    public void insert(T key) {
        TreeNode<T> node = new TreeNode<>(key, BLACK, null, null, null);
    ...
    public TreeNode<T> iterativeSearch(T key) {
