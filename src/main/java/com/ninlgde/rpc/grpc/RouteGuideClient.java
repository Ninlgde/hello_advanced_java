...
public class RouteGuideClient {
    ...
    private final GreeterGrpc.GreeterBlockingStub hwBlockingStub;
    ...
    public RouteGuideClient(Channel channel) {
        ...
        hwBlockingStub = GreeterGrpc.newBlockingStub(channel);
    }
    ...
    public void greet(String name) {
        ...
        HelloReply response;
        try {
            response = hwBlockingStub.withDeadlineAfter(3, TimeUnit.SECONDS).sayHello(request);
