...
import com.ninlgde.rpc.grpc.RouteGuideUtil;
import com.ninlgde.rpc.grpc.proto.*;
...
//                logger.log(Level.INFO, "note" + note.toString());
                List<RouteNote> notes = getOrCreateNotes(note.getLocation());
//                logger.log(Level.INFO, "notes: " + notes.size());

                // Respond with all previous notes at this location.
                for (RouteNote prevNote : notes.toArray(new RouteNote[1])) {
//                    logger.log(Level.INFO, "routeChat" + prevNote.toString());
                    responseObserver.onNext(prevNote);
                }

                // Now add the new note to the list
                notes.add(note);
//                logger.log(Level.INFO, "notes after: " + notes.size());
            }
